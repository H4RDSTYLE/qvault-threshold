"""
QVault Threshold — Shamir's Secret Sharing over GF(p)
======================================================
Split a secret (e.g. an AES-256 key) into N shares so that:
...
This is information-theoretic security — not computational.  No assumption
about an adversary's computing power is made, quantum or otherwise.

The secret is the constant term f(0) of a random degree-(K-1) polynomial
over GF(P), where P is the 256-bit secp256k1 prime.
